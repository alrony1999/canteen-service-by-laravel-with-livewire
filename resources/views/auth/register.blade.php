                            ...
                            <div class="register-form form-item ">
                                ...
                                <form class="form-stl" action="{{ route('register') }}" name="frm-login"
                                    ...
                                    <fieldset class="wrap-title">
                                        ...
                                        <h3 class="form-title">Student infomation</h3>
                                    </fieldset>
                                    ...
                                    {{-- <fieldset class="wrap-input">
                                        <label for="frm-reg-lname">Student Id</label>
                                        <input type="text" id="frm-reg-lname" :value="student_id" name="student_id"
                                            placeholder="Only student can create an account" required autofocus
