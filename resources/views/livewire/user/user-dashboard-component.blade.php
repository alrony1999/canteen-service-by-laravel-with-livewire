        ...
        <div class="row">
                ...
                <div class="icon-stat">
                    <div class="row">
                        <div class="col-xs-8 text-left">
                            ...
                            <span class="icon-stat-value"><i class="fa fa-rmb"></i>{{ $totalCost }}</span>
                        </div>
                        <div class="col-xs-4 text-center">
                            <i class="fa fa-rmb icon-stat-visual bg-secondary"></i>
                        </div>
                    </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="icon-stat">
                    <div class="row">
                        <div class="col-xs-8 text-left">
                            <span class="icon-stat-label">Total Recived Orders</span>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="icon-stat">
                    <div class="row">
                        <div class="col-xs-8 text-left">
                            <span class="icon-stat-label">Total Canceled Orders</span>
                                ...
                                @foreach ($orders as $order)
                                    <tr>
                                        ...
                                        @if ($order->order_mode == 'delivery')
                                            <td>Delivery</td>
                                        @elseif($order->order_mode == 'pick-up')
                                            <td>Pick up</td>
                                        @endif
