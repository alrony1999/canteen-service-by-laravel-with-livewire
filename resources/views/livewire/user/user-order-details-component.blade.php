                        ...
                        <div class="wrap-iten-in-cart">
                            ...
                            <ul class="products-cart">
                                ...
                                <li class="pr-cart-item">
                                    ...
                                    @if ($order->order_status == 'delivered' && $order->review_status == false or $order->deliveryman_status == 'delivered' && $order->review_status == false)
                                        <div class="price-field sub-total">
                                            <p class="price"><a
                                                    href="{{ route('user.review', ['order_item_id' => $order->id]) }}">Write
                                                    Review</a></p>
                                        </div>
                                    @endif
