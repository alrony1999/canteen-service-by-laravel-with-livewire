    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <ul class="nav">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link"
                                    href="{{ route('seller.foods') }}">All
                                    Foods</a>
                            </li>
                            <li class="nav-item"> <a class="nav-link"
                                    href="{{ route('seller.addfood') }}">Add new
                                    Foods</a>
                            </li>
                ...
                <li class="nav-item menu-items">
                    <a class="nav-link" data-toggle="collapse" href="#seller" aria-expanded="false"
                    ...
                    <div class="collapse" id="seller">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item"> <a class="nav-link"
                                    href="{{ route('seller.pickup-orders') }}">Pending Pick-up
                                    Orders</a></li>
                            <li class="nav-item"> <a class="nav-link"
                                    href="{{ route('seller.delivery-type-orders') }}">Pending
                                    Delivery
                                    Orders</a></li>
                            <li class="nav-item"> <a class="nav-link"
                                    href="{{ route('seller.today') }}">Total
                                    Order
                ...
                <li class="nav-item menu-items">
                    <a class="nav-link" href="{{ route('seller.orders') }}">
                        ...
                        <span class="menu-title">All
                            Orders</span>
                    </a>
                </li>

                <li class="nav-item menu-items">
                    <a class="nav-link" href="{{ route('seller.highchart') }}">
                        <span class="menu-icon">
