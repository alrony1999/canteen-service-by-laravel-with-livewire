    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <ul class="nav">
                ...
                <li class="nav-item menu-items">
                    <a href="{{ route('admin.addseller') }}" class="nav-link">
                        <span class="menu-icon">
                            <i class="mdi mdi-speedometer"></i>
                        </span>
                        <span class="menu-title">Add
                ...
                <li class="nav-item menu-items">
                    <a href="{{ route('admin.deliverymen') }}" class="nav-link">
                        <span class="menu-icon">
                            <i class="mdi mdi-speedometer"></i>
                        </span>
                        <span class="menu-title">All
                ...
                <li class="nav-item menu-items">
                    <a href="{{ route('admin.adddeliveryman') }}" class="nav-link">
                        <span class="menu-icon">
                            <i class="mdi mdi-speedometer"></i>
                        </span>
                        <span class="menu-title">Add
                            new Deliverymen</span>
                    </a>
                </li>
                ...
                <li class="nav-item menu-items">
                    <a class="nav-link" href="{{ route('admin.highchart') }}">
                        <span class="menu-icon">
