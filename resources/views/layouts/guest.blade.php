                                    ...
                                    @auth
                                        @if (Auth::user()->utype === 'A')
                                            <li class="menu-item menu-item-has-children parent">
                                                <a title="My Account" href="#">Admin ({{ Auth::user()->name }})<i
                                        ...
                                        @elseif (Auth::user()->utype === 'S')
                                            <li class="menu-item menu-item-has-children parent">
                                                <a title="My Account" href="#">Seller ({{ Auth::user()->name }})<i
                                                        class="fa fa-angle-down" aria-hidden="true"></i></a>
                                                <ul class="submenu curency">
                                                    <li class="menu-item">
                                                        <a title="Dashboard"
                                                            href="{{ route('seller.dashboard') }}">Dashboard</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ route('logout') }}"
                                                            onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
                                        ...
                                        @elseif (Auth::user()->utype === 'D')
                                            <li class="menu-item menu-item-has-children parent">
                                                <a title="My Account" href="#">Deliver Men ({{ Auth::user()->name }})<i
                                                        class="fa fa-angle-down" aria-hidden="true"></i></a>
                                                <ul class="submenu curency">
                                                    <li class="menu-item">
                                                        <a title="Dashboard"
                                                            href="{{ route('deliveryman.dashboard') }}">Dashboard</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ route('logout') }}"
                                                            onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
